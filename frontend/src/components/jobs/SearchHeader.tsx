        ...
        <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
          <div className="relative flex-1">
            ...
            <Input
              ...
              aria-label="חפש משרות, חברות או מילות מפתח"
              autoComplete="off"
            />
          </div>
          ...
          <div className="flex gap-2">
            <Button
              ...
              aria-label={`פתח סינונים${activeFiltersCount > 0 ? ` (${activeFiltersCount} פעילים)` : ''}`}
            >
            ...
            <Button asChild variant="outline" className="h-11 gap-2">
              <Link to={createPageUrl("SavedJobs")} aria-label="צפה במשרות שמורות">
